            ...
            <BodyTable>
              {empleado.map((item,index)=>(
                <tr key={index}>
                  ...
                  <ButtonsOptions item={item} Permiso={UpdatePermiso} Eliminar={EliminarEmpleado} Actualizar={AbrirActualizar}  />
 ...
 */}
 <InputText label="Phone" type="number" max={10} value={telefono} onChange={setTelefono} required />
